...
extern "C" void cudaResize(uchar4 *d_dst, int dstW, int dstH, uchar4 *d_src, int srcW, int srcH);
...
extern "C" void cudaVisualComfort( uchar4 *d_dst1, uchar4 *d_dst2, uchar4 *d_src1, uchar4 *d_src2, int imageW, int imageH );
extern "C" void cudaWarpImage( uchar4 *d_dst, uchar4 *d_src, int imageW, int imageH, double *matrix );
